...
$comments = $db_handle->runQuery("SELECT * FROM events");
?>
...
?>
<div class="message-box" id="message_<?php echo $comments[$k]["event_id"];?>">
<div>
<button class="btnEditAction" name="edit" id="<?php echo $comments[$k]["event_id"];?>">Edit</button>
<button class="btnDeleteAction" name="delete" onClick="callCrudAction('delete',<?php echo $comments[$k]["event_id"]; ?>)">Delete</button>
</div>
<div class="message-content"><?php echo $comments[$k]["event_title"]; ?></div>
</div>
<?php
}
} ?>
