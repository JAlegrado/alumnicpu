		...
		<div class="col-sm-6 col-md-4 col-md-offset-1">
			<div class="panel panel-default">
				<div class="panel-heading bg-primary col-sm-12 col-md-10  col-md-offset-1 text-light ">
					<center><strong>College Entry</strong></center>
				</div>
                <br>
				<div class="panel-body">
					<form role="form"  method="post" action="index.php?page=create_college">
						<fieldset>
								...
								<div class="col-sm-12 col-md-10  col-md-offset-1 ">
									...
									<div class="form-group">
										<div class="input-group">
											...
											<input class="form-control text-center" placeholder="College" name="college" type="text" autofocus>
										</div>
									</div>
