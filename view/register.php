...
<div class="container-fluid">
  ...
  <div class ="col-lg-2"></div>
	...
	<div class="box-default">
					...
					<center><h2>Create New Account</h2><br></center>
						<div class="row">
						<div class="col-lg-4 col-xs-4">
							<label>First Name</label>
										<input class="form-control text-center" placeholder="Juan" name="firstname" type="text" autofocus>
									</div>
						<div class="col-lg-4 col-xs-4"> 
							<label>Middle Name</label>
										<input class="form-control text-center" placeholder="Protacio" name="middlename" type="text" autofocus>
									</div>
						<div class="col-lg-4 col-xs-4">
							<label>Last Name</label>
										<input class="form-control text-center" placeholder="Dela Cruz" name="lastname" type="text" autofocus>
									</div>
									</div>
								<br>
						<div class="row">
						...
						<div class="col-lg-4 col-xs-4">
							<label>Year Graduated</label>
									...
									<select Name='yeargraduated' class='form-control'>
										<option value="">--- Select ---</option>
										<?php
											for ($x=date("Y"); $x>1904; $x--)
  											{
						...
						<div class="col-lg-6 xs-6">
							<label>Contact Number</label>
										<input class="form-control text-center" placeholder="0912145679" name="contact" type="text">
									</div>
									</div>
								<br>
								<div class="row">
						<div class="col-lg-9 col-xs-9">
							<label>Address line</label>
								<input class="form-control text-center" placeholder="..." name="addressline" type="text" autofocus>
								</div>
						<div class="col-lg-3 col-xs-3">
						<label>Zip code</label>
						<input class="form-control text-center" placeholder="..." name="zip" type="text" autofocus>
								</div>	
</div>	
								<br>
								<div class="row">
						<div class="col-lg-4 col-xs-4">
							<label>City</label>
										<input class="form-control text-center" placeholder="..." name="city" type="text" autofocus>
									</div>
						<div class="col-lg-4 col-xs-4"> 
							<label>State/Province/Region</label>
										<input class="form-control text-center" placeholder="..." name="spr" type="text" autofocus>
									</div>
						<div class="col-lg-4 col-xs-4">
							<label>Country</label>
							<?php
											echo "<select name='country' class='form-control'>";
												foreach($countries as $country_code => $arr){echo '<option value="'.$country_code.'">'.$arr['country'].'</option>';}
											echo "</select>"
									?>				
									</div>
									</div>
						...
						<div class="col-lg-6 xs-6">
							<label>Email Address</label>		
										<input class="form-control text-center" placeholder="juandelacruz@gmail.com" name="email" type="text">		
									</div>	
						<div class="col-lg-6 xs-6">			
							<label>Social Media Account</label>		
										<input  class="form-control text-center" placeholder="@juandelacruz" name="social" type="text">
									</div>
									</div>
								<br>
								<input class="form-control text-center"  name="role" type="hidden" value="User">
						<div class="row">
						<div class="col-lg-6 xs-6">
							<label>Username</label>
										<input class="form-control text-center" placeholder="juan1214" name="username" type="text" autofocus>
									</div>
						<div class="col-lg-6 xs-6">
							...
							<center>
								<input type="submit" class="btn btn-lg btn-dark"  name="proceed" value="Proceed" data-toggle="modal" data-target="#myModal"><br><br>	
								<a class="btn-sm" href="index.php?command=0">Back to Login</a>	
							</center>
							<br> <br>
							</fieldset>
						</div>
						<div class="modal fade modal-dialog" id="myModal" role="dialog">
