...
<div class="container-fluid mt-0 mb-2">
    <div class="row">
        ...
        <div class="col-sm-4  col-md-offset-1" style="background-color:#030A28;font-size:22px;color:white;">
            <fieldset>
            <form enctype="multipart/form-data" action="index.php?page=user_change_password" name="form" method="post">
           
				    <span class="input-group-addon bg-danger form-control text-center text-light">
				    <i class="glyphicon glyphicon-user container ">User Profile</i>
                ...
                <?php
					...
					$result = $this->model->view_profile($user_id);
					foreach($result as $title=>$Mymessage)
	                {
                        ...
                        <input class='form-control text-center' name='addressline' type='text' value='".$Mymessage->addressline."' autofocus>
                        ...
                        <input class='form-control text-center' name='city' type='text' value='".$Mymessage->city."' autofocus>
                        
                        <span class='input-group-addon'>
				        <i class='glyphicon glyphicon-user'></i>
				            SPR:
				        </span> 
                        <input class='form-control text-center' name='spr' type='text' value='".$Mymessage->spr."' autofocus>
                       
                        <span class='input-group-addon'>
				        <i class='glyphicon glyphicon-user'></i>
				            Zip:
				        </span> 
                        <input class='form-control text-center' name='zip' type='text' value='".$Mymessage->zip."' >

                        <span class='input-group-addon'>
				        <i class='glyphicon glyphicon-user'></i>
				            Social Media:
				        </span> 
                        <input class='form-control text-center' name='social' type='text' value='".$Mymessage->social."' >

                        <span class='input-group-addon'>
				        <i class='glyphicon glyphicon-user'></i>
				            Contact Number:
				        </span> 
                        <input class='form-control text-center' name='contact' type='text' value='".$Mymessage->contact."' >
                        ...
                        <input class='form-control text-center' name='email' type='text' value='".$Mymessage->email."' >
                        ...
                        echo '<option value="'.$country_code.'">'.$arr['country'].'</option>';
                        }
					...
					<input class='form-control text-center' name='username' type='text' value='".$Mymessage->username."' >
					...
					<input class='form-control text-center' name='password' type='text' value='".$Mymessage->password."' >
...
<div class="form-group">
		    ...
		    <div class="form-group">
			    <input type="submit" class="btn btn-lg btn-primary btn-block text-center bg-transparent" style="border:30px solid;border-color:black;" value="Update User Profile">
		    </div>
